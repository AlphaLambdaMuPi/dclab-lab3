...
module Core_mm_interconnect_0 (
	...
	wire    [8:0] rsp_mux_src_channel;                                                                               // rsp_mux:src_channel -> video_pixel_buffer_dma_avalon_pixel_dma_master_agent:rp_channel
	...
	wire    [8:0] cmd_mux_001_src_channel;                                                                           // cmd_mux_001:src_channel -> audio_avalon_audio_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_002_src_channel;                                                                           // cmd_mux_002:src_channel -> audio_and_video_config_avalon_av_config_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                                           // cmd_mux_003:src_channel -> video_pixel_buffer_dma_avalon_control_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                                           // cmd_mux_004:src_channel -> jtag_uart_avalon_jtag_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_005_src_channel;                                                                           // cmd_mux_005:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                                           // cmd_mux_006:src_channel -> nios2_cpu_debug_mem_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                                           // cmd_mux_007:src_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_008_src_channel;                                                                           // cmd_mux_008:src_channel -> sdram_controller_s1_agent:cp_channel
	...
	wire    [8:0] router_001_src_channel;                                                                            // router_001:src_channel -> nios2_cpu_data_master_limiter:cmd_sink_channel
	...
	wire    [8:0] nios2_cpu_data_master_limiter_cmd_src_channel;                                                     // nios2_cpu_data_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [8:0] rsp_mux_001_src_channel;                                                                           // rsp_mux_001:src_channel -> nios2_cpu_data_master_limiter:rsp_sink_channel
	...
	wire    [8:0] nios2_cpu_data_master_limiter_rsp_src_channel;                                                     // nios2_cpu_data_master_limiter:rsp_src_channel -> nios2_cpu_data_master_agent:rp_channel
	...
	wire    [8:0] router_002_src_channel;                                                                            // router_002:src_channel -> nios2_cpu_instruction_master_limiter:cmd_sink_channel
	...
	wire    [8:0] nios2_cpu_instruction_master_limiter_cmd_src_channel;                                              // nios2_cpu_instruction_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire    [8:0] rsp_mux_002_src_channel;                                                                           // rsp_mux_002:src_channel -> nios2_cpu_instruction_master_limiter:rsp_sink_channel
	...
	wire    [8:0] nios2_cpu_instruction_master_limiter_rsp_src_channel;                                              // nios2_cpu_instruction_master_limiter:rsp_src_channel -> nios2_cpu_instruction_master_agent:rp_channel
	...
	wire    [8:0] cmd_mux_src_channel;                                                                               // cmd_mux:src_channel -> sram_avalon_sram_slave_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_demux_002_src2_channel;                                                                        // cmd_demux_002:src2_channel -> cmd_mux_008:sink1_channel
	...
	wire    [8:0] rsp_demux_008_src1_channel;                                                                        // rsp_demux_008:src1_channel -> rsp_mux_002:sink2_channel
	...
	wire    [8:0] cmd_demux_001_src0_channel;                                                                        // cmd_demux_001:src0_channel -> nios2_cpu_data_master_to_sram_avalon_sram_slave_cmd_width_adapter:in_channel
	...
	wire    [8:0] nios2_cpu_data_master_to_sram_avalon_sram_slave_cmd_width_adapter_src_channel;                     // nios2_cpu_data_master_to_sram_avalon_sram_slave_cmd_width_adapter:out_channel -> cmd_mux:sink1_channel
	...
	wire    [8:0] rsp_demux_src1_channel;                                                                            // rsp_demux:src1_channel -> sram_avalon_sram_slave_to_nios2_cpu_data_master_rsp_width_adapter:in_channel
	...
	wire    [8:0] sram_avalon_sram_slave_to_nios2_cpu_data_master_rsp_width_adapter_src_channel;                     // sram_avalon_sram_slave_to_nios2_cpu_data_master_rsp_width_adapter:out_channel -> rsp_mux_001:sink0_channel
	...
	wire    [8:0] cmd_demux_001_src1_channel;                                                                        // cmd_demux_001:src1_channel -> crosser:in_channel
	...
	wire    [8:0] crosser_001_out_channel;                                                                           // crosser_001:out_channel -> cmd_mux_002:sink0_channel
	...
	wire    [8:0] crosser_002_out_channel;                                                                           // crosser_002:out_channel -> rsp_mux_001:sink1_channel
	...
	wire    [8:0] rsp_demux_002_src0_channel;                                                                        // rsp_demux_002:src0_channel -> crosser_003:in_channel
	...
	wire    [8:0] nios2_cpu_data_master_limiter_cmd_valid_data;                                                      // nios2_cpu_data_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	wire    [8:0] nios2_cpu_instruction_master_limiter_cmd_valid_data;                                               // nios2_cpu_instruction_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
