...
module Core_mm_interconnect_0 (
	...
	wire  [95:0] audio_avalon_audio_slave_agent_rf_source_data;                                   // audio_avalon_audio_slave_agent:rf_source_data -> audio_avalon_audio_slave_agent_rsp_fifo:in_data
	...
	wire  [95:0] audio_avalon_audio_slave_agent_rsp_fifo_out_data;                                // audio_avalon_audio_slave_agent_rsp_fifo:out_data -> audio_avalon_audio_slave_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_src_data;                                                                // cmd_mux:src_data -> audio_avalon_audio_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                               // audio_avalon_audio_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [5:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> audio_avalon_audio_slave_agent:cp_channel
	...
	wire  [18:0] audio_and_video_config_avalon_av_config_slave_agent_m0_address;                  // audio_and_video_config_avalon_av_config_slave_agent:m0_address -> audio_and_video_config_avalon_av_config_slave_translator:uav_address
	...
	wire  [95:0] audio_and_video_config_avalon_av_config_slave_agent_rf_source_data;              // audio_and_video_config_avalon_av_config_slave_agent:rf_source_data -> audio_and_video_config_avalon_av_config_slave_agent_rsp_fifo:in_data
	...
	wire  [95:0] audio_and_video_config_avalon_av_config_slave_agent_rsp_fifo_out_data;           // audio_and_video_config_avalon_av_config_slave_agent_rsp_fifo:out_data -> audio_and_video_config_avalon_av_config_slave_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> audio_and_video_config_avalon_av_config_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                           // audio_and_video_config_avalon_av_config_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> audio_and_video_config_avalon_av_config_slave_agent:cp_channel
	...
	wire  [95:0] sysid_qsys_control_slave_agent_rf_source_data;                                   // sysid_qsys_control_slave_agent:rf_source_data -> sysid_qsys_control_slave_agent_rsp_fifo:in_data
	...
	wire  [95:0] sysid_qsys_control_slave_agent_rsp_fifo_out_data;                                // sysid_qsys_control_slave_agent_rsp_fifo:out_data -> sysid_qsys_control_slave_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> sysid_qsys_control_slave_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                           // sysid_qsys_control_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [94:0] cmd_mux_004_src_data;                                                            // cmd_mux_004:src_data -> nios2_cpu_debug_mem_slave_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                           // nios2_cpu_debug_mem_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                         // cmd_mux_004:src_channel -> nios2_cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [95:0] onchip_memory2_s1_agent_rf_source_data;                                          // onchip_memory2_s1_agent:rf_source_data -> onchip_memory2_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] onchip_memory2_s1_agent_rsp_fifo_out_data;                                       // onchip_memory2_s1_agent_rsp_fifo:out_data -> onchip_memory2_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                            // cmd_mux_005:src_data -> onchip_memory2_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                           // onchip_memory2_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                         // cmd_mux_005:src_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire  [94:0] audio_avalon_audio_slave_agent_rp_data;                                          // audio_avalon_audio_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [94:0] audio_and_video_config_avalon_av_config_slave_agent_rp_data;                     // audio_and_video_config_avalon_av_config_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] sysid_qsys_control_slave_agent_rp_data;                                          // sysid_qsys_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] nios2_cpu_debug_mem_slave_agent_rp_data;                                         // nios2_cpu_debug_mem_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [94:0] onchip_memory2_s1_agent_rp_data;                                                 // onchip_memory2_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [94:0] router_src_data;                                                                 // router:src_data -> nios2_cpu_data_master_limiter:cmd_sink_data
	...
	wire  [94:0] nios2_cpu_data_master_limiter_cmd_src_data;                                      // nios2_cpu_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [94:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> nios2_cpu_data_master_limiter:rsp_sink_data
	...
	wire  [94:0] nios2_cpu_data_master_limiter_rsp_src_data;                                      // nios2_cpu_data_master_limiter:rsp_src_data -> nios2_cpu_data_master_agent:rp_data
	...
	wire  [94:0] router_001_src_data;                                                             // router_001:src_data -> nios2_cpu_instruction_master_limiter:cmd_sink_data
	...
	wire  [94:0] nios2_cpu_instruction_master_limiter_cmd_src_data;                               // nios2_cpu_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [94:0] rsp_mux_001_src_data;                                                            // rsp_mux_001:src_data -> nios2_cpu_instruction_master_limiter:rsp_sink_data
	...
	wire  [94:0] nios2_cpu_instruction_master_limiter_rsp_src_data;                               // nios2_cpu_instruction_master_limiter:rsp_src_data -> nios2_cpu_instruction_master_agent:rp_data
	...
	wire  [94:0] cmd_demux_001_src0_data;                                                         // cmd_demux_001:src0_data -> cmd_mux_004:sink1_data
	wire         cmd_demux_001_src0_ready;                                                        // cmd_mux_004:sink1_ready -> cmd_demux_001:src0_ready
	wire   [5:0] cmd_demux_001_src0_channel;                                                      // cmd_demux_001:src0_channel -> cmd_mux_004:sink1_channel
	...
	wire  [94:0] rsp_demux_004_src1_data;                                                         // rsp_demux_004:src1_data -> rsp_mux_001:sink0_data
	wire         rsp_demux_004_src1_ready;                                                        // rsp_mux_001:sink0_ready -> rsp_demux_004:src1_ready
	wire   [5:0] rsp_demux_004_src1_channel;                                                      // rsp_demux_004:src1_channel -> rsp_mux_001:sink0_channel
	...
	wire  [94:0] cmd_demux_src1_data;                                                             // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [94:0] crosser_001_out_data;                                                            // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [94:0] rsp_demux_src0_data;                                                             // rsp_demux:src0_data -> crosser_002:in_data
	...
	wire  [94:0] crosser_002_out_data;                                                            // crosser_002:out_data -> rsp_mux:sink0_data
	...
	wire  [94:0] rsp_demux_001_src0_data;                                                         // rsp_demux_001:src0_data -> crosser_003:in_data
	...
	wire  [94:0] crosser_003_out_data;                                                            // crosser_003:out_data -> rsp_mux:sink1_data
	...
	Core_mm_interconnect_0_router_006 router_006 (
	...
	Core_mm_interconnect_0_router_006 router_007 (
	...
	Core_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Core_mm_interconnect_0_cmd_mux_004 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Core_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Core_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Core_mm_interconnect_0_rsp_demux_004 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
